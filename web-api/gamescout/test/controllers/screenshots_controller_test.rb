...
class ScreenshotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screenshot" do
    assert_difference("Screenshot.count") do
      post screenshots_url, params: { screenshot: { game_id: @screenshot.game_id, url: @screenshot.url } }
    end
  ...
  test "should update screenshot" do
    patch screenshot_url(@screenshot), params: { screenshot: { game_id: @screenshot.game_id, url: @screenshot.url } }
