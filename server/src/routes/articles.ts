...
router.get('/:article_id', asyncHandler(async (req, res) => {
...
router.put('/:article_id', asyncHandler(async (req, res) => {
    const { article_title, article_owner, article_content } = req.body;
...
router.delete('/:article_id', asyncHandler(async (req, res) => {
...
router.get('/comments/by-article/:article_id', asyncHandler(async (req, res) => {
    const comments = await commentService.getAllCommentsByArticleId(req.params.article_id);
    res.status(200).json({ comments });
}));

router.get('/comment/:comment_id', asyncHandler(async (req, res) => {
...
router.put('/comment/:comment_id', asyncHandler(async (req, res) => {
    const { comment_owner, commented_article, comment_content } = req.body;
